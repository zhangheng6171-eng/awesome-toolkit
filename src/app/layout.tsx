...
export const metadata: Metadata = {
  metadataBase: new URL('https://awesome-toolkit.pages.dev'),
  ...
  openGraph: {
    ...
    locale: 'zh_CN',
    type: 'website',
    images: [{ url: 'https://awesome-toolkit.pages.dev/og-image.png', width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Awesome Toolkit — 开源工具一键部署',
    description: '从 GitHub 精选 50+ 最强开源工具，提供一键部署方案',
    images: ['https://awesome-toolkit.pages.dev/og-image.png'],
  },
  robots: {
    index: true,
    follow: true,
